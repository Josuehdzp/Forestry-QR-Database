...
public class Adaptador extends RecyclerView.Adapter<Adaptador.ViewHolder> {
    ...
    public Adaptador(List<ListaD> developersLists, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        final ListaD developersList = developersLists.get(position);
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ListaD developersList1 = developersLists.get(position);
                Intent skipIntent = new Intent(v.getContext(), Perfil.class);
