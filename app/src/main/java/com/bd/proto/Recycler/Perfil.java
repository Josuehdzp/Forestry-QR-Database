...
public class Perfil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String userName = intent.getStringExtra(Adaptador.KEY_NAME);
        String image = intent.getStringExtra(Adaptador.KEY_IMAGE);
        final String profileUrl = intent.getStringExtra(Adaptador.KEY_URL);
